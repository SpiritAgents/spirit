...
impl TuiShell {
    pub fn view_model(&self) -> TuiViewModel {
        ...
        TuiViewModel {
            ...
            marketplace_picker_active: self.marketplace_picker_active,
            marketplace_picker_index: self.marketplace_picker_index,
            marketplace_catalog: self.marketplace_catalog.clone(),
