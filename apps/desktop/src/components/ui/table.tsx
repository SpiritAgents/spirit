...
function TableFooter({ className, ...props }: React.ComponentProps<"tfoot">) {
  return (
    <tfoot
      ...
      className={cn(`border-t bg-muted/50 ${FONT_WEIGHT_NORMAL} [&>tr]:last:border-b-0`, className)}
      {...props}
    />
  );
}
...
function TableRow({ className, ...props }: React.ComponentProps<"tr">) {
  return (
    <tr
      data-slot="table-row"
      className={cn(
        "border-b transition-colors hover:bg-canvas-hover has-aria-expanded:bg-canvas-hover data-[state=selected]:bg-canvas-hover",
        className,
      )}
      {...props}
    />
