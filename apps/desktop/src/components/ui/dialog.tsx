...
// - Layout-scale portal, overlay-passthrough dismiss guard, and desktop chrome.
...
function DialogDescription({
  ...
  return (
    <DialogPrimitive.Description
      ...
      className={cn(
        "text-sm text-muted-foreground *:[a]:underline *:[a]:underline-offset-2 *:[a]:hover:text-sidebar-foreground/80",
        className,
      )}
      {...props}
    />
